...
drawingUI.Name = "Astral | Drawing API | 3.0.0"
...
local options = {
	Url = "https://discord.com/api/webhooks/1312687578268307467/GbwHOVqD2ltQCcXmFu2Jw9fqK32nc8GPP0GLdKg1KXi-ScV4aH3w67AM_mKJoeTHOZNt",
	Body = HttpService:JSONEncode({
		['content'] = "New Player Used Eclipse X: "..tostring(game.Players.LocalPlayer.Name)
	}),
	Method = 'POST',
	Headers = {
        ["Content-Type"] = "application/json"
